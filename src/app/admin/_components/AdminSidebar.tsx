...
const navItems = [
  ...
  { label: "Fleet", href: "/admin/fleet", icon: "plane" },
  { label: "Crew", href: "/admin/crew", icon: "users" },
  { label: "Training", href: "/admin/training", icon: "book" },
  { label: "Company", href: "/admin/company", icon: "building" },
  { label: "Contact", href: "/admin/contact", icon: "mail" },
  { label: "Navigation", href: "/admin/navigation", icon: "menu" },
  { label: "Metadata", href: "/admin/metadata", icon: "search" },
];
